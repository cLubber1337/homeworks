...
const SuperEditableSpan: React.FC<SuperEditableSpanType> = (
    ...
    const onEnterCallback = () => {
        if("Enter") {    // выключить editMode при нажатии Enter // делают студенты
            setEditMode(false)
        }
    ...
    const onBlurCallback = (e: React.FocusEvent<HTMLInputElement>) => {
        if(e) {        // выключить editMode при нажатии за пределами инпута // делают студенты
            setEditMode(false)
        }
    ...
    const onDoubleClickCallBack = (e: React.MouseEvent<HTMLSpanElement, MouseEvent>) => {
         if(e) {        // включить editMode при двойном клике // делают студенты
             setEditMode(true)
         }
        onDoubleClick?.(e)
    }
